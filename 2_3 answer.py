# -*- coding: utf-8 -*-
"""
Created on Tue Sep 22 15:52:00 2015
...
def process_file(f):
    ...
    with open("{}/{}".format(datadir, f), "r") as html:
        ...
        DataGrid1 = soup.find(id = 'DataGrid1')
        for tr in DataGrid1.find_all('tr')[1:]:
            flghts={}            
            td = tr.find_all('td')
            if td[1].string != "TOTAL":
                info['year'] = int(td[0].string)
                info['month'] = int(td[1].string)
                flghts['domestic'] = int(td[2].string.replace(",",""))
                flghts['international'] = int(td[3].string.replace(",",""))
                info['flights'] = flghts
                data.append(info)        
